...
最后说说Service。Kubernetes Proxy API也有**Service的Proxy接口**，其接口定义与Pod的接口定义基本一样：/api/v1/proxy/namespaces/{namespace}/services/{name}。比如，若我们想访问MyWeb这个Service，则可以在浏览器里输入 http://192.168.18.131:8080/api/v1/proxy/namespaces/default/services/myweb/demo/。
