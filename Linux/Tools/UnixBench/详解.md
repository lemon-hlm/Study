...
- [4 运行参数](#4-运行参数)
- [5 测试得分项说明](#5-测试得分项说明)
  - [5.1 Dhrystone 2 using register variables: 整数性能](#51-dhrystone-2-using-register-variables-整数性能)
...
很多人就拿了2873.4那个分数去比了，但是上面那个单进程结果949.9也有意义，但凡接触了这么多案例，没人关心过。多进程结果就是根据系统CPU核数，同时起多个进程的结果；单进程就是只起一个进程的结果，对于系统性能来说，两个结果都是有意义的。
...
## 5.1 Dhrystone 2 using register variables: 整数性能
