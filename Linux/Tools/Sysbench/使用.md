...
- [2 使用](#2-使用)
  ...
  - [2.5 pgsql选项](#25-pgsql选项)
  - [2.6 sysbench fileio help](#26-sysbench-fileio-help)
  - [2.7 sysbench cpu help](#27-sysbench-cpu-help)
  - [2.8 sysbench memory help](#28-sysbench-memory-help)
  - [2.9 sysbench threads help](#29-sysbench-threads-help)
  - [2.10 sysbench mutex help](#210-sysbench-mutex-help)
...
oltp\_\*.lua: a collection of OLTP-like database benchmarks （OLTP数据库 如MySQL、Oracle、PostgreSQL）
